                ...
                return (
                  <View key={step.status} className="flex-row items-start mb-1">
                    <View className="items-center mr-3">
                      <View
                        className={`w-8 h-8 rounded-full items-center justify-center ${isCompleted ? "bg-primary" : "bg-muted"}`}
                      >
                        <StepIcon
                          size={16}
                          color={isCompleted ? "white" : "#a8a29e"}
                        />
                      </View>
      ...
      <View className="absolute bottom-0 left-0 right-0 bg-card border-t border-border px-6 py-4 flex-row gap-3">
        {(order.status === "pending" || order.status === "confirmed") && (
          <TouchableOpacity
            ...
            className="flex-1 border border-destructive py-3 rounded-xl items-center"
          >
